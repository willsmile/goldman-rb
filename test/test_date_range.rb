...
class TestDateRange < Minitest::Test
  def test_date_range_with_nil_params
    date_range = Goldman::DateRange.new(start_date_str: nil,
                                        end_date_str: nil,
                                        day_str: nil,
                                        week_str: nil)
  ...
  def test_date_range_with_options_start_date_only
    ...
    date_range = Goldman::DateRange.new(start_date_str: start_date.strftime("%F"),
                                        end_date_str: nil,
                                        day_str: nil,
                                        week_str: nil)
  ...
  def test_date_range_with_options_start_date_is_after_end_date
    ...
    assert_raises Goldman::ParameterError do
      Goldman::DateRange.new(start_date_str: start_date.strftime("%F"),
                             end_date_str: end_date.strftime("%F"),
                             day_str: nil,
                             week_str: nil)
    end
  ...
  def test_date_range_with_options_invalid_start_date
    assert_raises Goldman::ParameterError do
      Goldman::DateRange.new(start_date_str: "invalid date",
                             end_date_str: nil,
                             day_str: nil,
                             week_str: nil)
    end
  ...
  def test_date_range_with_options_invalid_day
    assert_raises Goldman::ParameterError do
      Goldman::DateRange.new(start_date_str: nil,
                             end_date_str: nil,
                             day_str: "invalid day",
                             week_str: nil)
    end
